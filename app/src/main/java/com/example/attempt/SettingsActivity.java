...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nameEditTxt = findViewById(R.id.settings_full_name);

        addressEditText = findViewById(R.id.settings_address);
        profileChageTextBtn = findViewById(R.id.profile_image_change_btn);
    ...
    private void updateOnlyUserInfo() {
        ...
        Toast.makeText(SettingsActivity.this,"Profile info saved",Toast.LENGTH_SHORT).show();
        finish();
    }
    ...
    private void userInfoSaved() {
        ...
        if(TextUtils.isEmpty(nameEditTxt.getText().toString())  || TextUtils.isEmpty(addressEditText.getText().toString())){
            Toast.makeText(SettingsActivity.this, "Please fill up all the fields",Toast.LENGTH_SHORT).show();
